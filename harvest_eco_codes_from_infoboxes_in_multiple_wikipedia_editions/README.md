...
* [wikibase-cli](https://codeberg.org/maxlath/wikibase-cli) `>= v15.12.0`
...
2/ Harvest the Wikipedia articles corresponding to those Wikidata items using [a custom template](https://codeberg.org/maxlath/wikidata-scripting/src/branch/main/harvest_eco_codes_from_infoboxes_in_multiple_wikipedia_editions/template.js)
```sh
